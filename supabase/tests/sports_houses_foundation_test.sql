...
select lives_ok(
 $$select public.upsert_sports_house('22222222-2222-4222-8222-222222222222','Eagles','EAG','#FFFFFF',1,'ec100000-0000-4000-8000-000000000001')$$,
 'school administrator creates a house through governed RPC'
);
select lives_ok(
 $$select public.upsert_sports_house('22222222-2222-4222-8222-222222222222','Sharks','SHA','#808080',2,'ec100000-0000-4000-8000-000000000002')$$,
 'school administrator may configure multiple houses'
);
select lives_ok(
 $$select public.upsert_sports_house('22222222-2222-4222-8222-222222222222','Cheetah','CHE','#F97316',3,'ec100000-0000-4000-8000-000000000003')$$,
...
select is((select color_hex from public.sports_houses where id='ec100000-0000-4000-8000-000000000003'),'#F97316','configured colour is preserved');
...
select lives_ok(
 $$select public.upsert_sports_age_group('22222222-2222-4222-8222-222222222222','Age 13',13,13,1,'ec120000-0000-4000-8000-000000000001')$$,
 'first school-defined age band is accepted'
);
select lives_ok(
 $$select public.upsert_sports_age_group('22222222-2222-4222-8222-222222222222','Age 14',14,14,2,'ec120000-0000-4000-8000-000000000002')$$,
 'second non-overlapping age band is accepted'
);
select throws_ok(
 $$select public.upsert_sports_age_group('22222222-2222-4222-8222-222222222222','Overlap',13,14,3,'ec120000-0000-4000-8000-000000000003')$$,
...
select throws_ok(
 $$select public.assign_learner_sports_house('22222222-2222-4222-8222-222222222222',2026,'ec200000-0000-4000-8000-000000000002','ec100000-0000-4000-8000-000000000001','manual',false)$$,
 'Learner must have an enrolment at the school for the sports year',
 'unenrolled learner cannot receive a house assignment'
);
select lives_ok(
 $$select public.assign_learner_sports_house('22222222-2222-4222-8222-222222222222',2026,'ec200000-0000-4000-8000-000000000001','ec100000-0000-4000-8000-000000000001','automatic',false)$$,
...
select lives_ok(
 $$select public.assign_staff_sports_house('22222222-2222-4222-8222-222222222222',2026,'ec300000-0000-4000-8000-000000000001','ec100000-0000-4000-8000-000000000001','leader','manual',true)$$,
 'placed staff member can become a governed house leader'
);
select throws_ok(
 $$select public.assign_staff_sports_house('22222222-2222-4222-8222-222222222222',2026,'ec300000-0000-4000-8000-000000000002','ec100000-0000-4000-8000-000000000002','member','manual',false)$$,
