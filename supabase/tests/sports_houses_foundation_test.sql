...
select is(
  (select count(*)::integer from public.sports_houses where school_id='22222222-2222-4222-8222-222222222222'),
  3,
  'school may configure its own number of houses'
);

select is(
  (select color_hex from public.sports_houses where id='ec100000-0000-4000-8000-000000000003'),
  '#F97316',
  'house colour is school data rather than a system constant'
);
...
select is(
  (select count(*)::integer from public.sports_age_groups where school_id='22222222-2222-4222-8222-222222222222'),
  3,
  'age groups are configurable per school'
);
...
select is(
  (select house_id from public.sports_learner_house_assignments where learner_id='ec200000-0000-4000-8000-000000000001' and academic_year=2026),
  'ec100000-0000-4000-8000-000000000001'::uuid,
  'valid enrolled learner receives one year-scoped house assignment'
);
...
select throws_ok(
  ...
  '23505',
  null,
  'learner cannot belong to two houses in the same school year'
);

select is(
  (select age_on_reference_date from public.sports_house_learner_roster where learner_id='ec200000-0000-4000-8000-000000000001'),
  14,
  'roster derives learner age from the configured reference date'
);

select is(
  (select age_group_label from public.sports_house_learner_roster where learner_id='ec200000-0000-4000-8000-000000000001'),
  'Age 14',
  'roster resolves the school-defined age group'
);
...
select is(
  (select role_key from public.sports_staff_house_assignments where id='ec320000-0000-4000-8000-000000000001'),
  'leader',
  'school can assign a staff house leader'
);
...
select throws_ok(
  ...
  '23505',
  null,
  'a house has at most one leader in a school year'
);
...
select is(
  ...
  3,
  'ordinary school member can read only sports houses in their accessible school'
);
