...
select throws_ok(
  $$insert into public.communication_templates(
      ...
      'actor.unrelated','email','Unrelated','cb100000-0000-4000-8000-000000000002'
    )$$,
...
select throws_ok(
  $$insert into public.communication_templates(
      ...
      '11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222',
      'actor.expired','email','Expired','cb100000-0000-4000-8000-000000000003'
    )$$,
  'Communication template creator is not authorized for school',
...
select lives_ok(
  $$insert into public.communication_templates(
      ...
      'cb110000-0000-4000-8000-000000000001','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222',
      'actor.valid','email','Valid','cb100000-0000-4000-8000-000000000001'
    )$$,
...
select lives_ok(
  $$insert into public.communication_templates(
      ...
      'cb110000-0000-4000-8000-000000000002','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222',
      'actor.platform','sms','Platform','cb100000-0000-4000-8000-000000000004'
    )$$,
...
select throws_ok(
  $$insert into public.communication_template_versions(
      ...
      'cb110000-0000-4000-8000-000000000001',1,'en','Bad creator','[]'::jsonb,'cb100000-0000-4000-8000-000000000002'
    )$$,
...
select lives_ok(
  $$insert into public.communication_template_versions(
      id,template_id,version,language,body_preview,variables,created_by_user_id
    ) values(
      'cb120000-0000-4000-8000-000000000001','cb110000-0000-4000-8000-000000000001',1,'en','Valid creator','[]'::jsonb,'cb100000-0000-4000-8000-000000000001'
    )$$,
...
select throws_ok(
  $$update public.communication_template_versions
       set status='approved',approved_by_user_id='cb100000-0000-4000-8000-000000000002',approved_at=now()
     where id='cb120000-0000-4000-8000-000000000001'$$,
...
select lives_ok(
  $$update public.communication_template_versions
       set status='approved',approved_by_user_id='cb100000-0000-4000-8000-000000000001',approved_at=now()
     where id='cb120000-0000-4000-8000-000000000001'$$,
...
select throws_ok(
  $$update public.communication_template_versions
       set approved_by_user_id='cb100000-0000-4000-8000-000000000004'
     where id='cb120000-0000-4000-8000-000000000001'$$,
