...
values
  ('fa130000-0000-4000-8000-000000000001','11111111-1111-4111-8111-111111111111','50000000-0000-4000-8000-000000000001','fa120000-0000-4000-8000-000000000001','guardian',91,current_date-10),
  ('fa130000-0000-4000-8000-000000000002','11111111-1111-4111-8111-111111111111','50000000-0000-4000-8000-000000000001','fa120000-0000-4000-8000-000000000002','guardian',92,current_date-10);
...
select is(
  jsonb_array_length((app_private.report_card_guardians_snapshot('50000000-0000-4000-8000-000000000001')->-2)->'addresses'),
  1,
  'report-card guardian snapshot exposes the postal address when both postal and physical addresses exist'
);

select is(
  ((app_private.report_card_guardians_snapshot('50000000-0000-4000-8000-000000000001')->-2)->'addresses'->0->>'type'),
  'postal',
  'report-card correspondence address is explicitly postal'
);

select is(
  ((app_private.report_card_guardians_snapshot('50000000-0000-4000-8000-000000000001')->-2)->'addresses'->0->>'line1'),
  'P.O. Box 123',
...
select is(
  jsonb_array_length((app_private.report_card_guardians_snapshot('50000000-0000-4000-8000-000000000001')->-1)->'addresses'),
  0,
