...
values
 ...
 ('fb100000-0000-4000-8000-000000000004','cross-doc-school-b-admin@example.test','authenticated','authenticated',now(),now());
...
values
 ...
 ('fb110000-0000-4000-8000-000000000004','11111111-1111-4111-8111-111111111111','fb100000-0000-4000-8000-000000000004','CROSS-B-ADMIN','School B','Admin','active');
...
values
 ...
 ('11111111-1111-4111-8111-111111111111','fb000000-0000-4000-8000-000000000001','fb100000-0000-4000-8000-000000000004','fb110000-0000-4000-8000-000000000004','school_admin',current_date-5);
...
insert into public.report_card_snapshots(
 id,tenant_id,school_id,learner_id,enrolment_id,academic_year,term_number,template_version,snapshot_version,data_snapshot,status,generated_by_user_id,certified_by_user_id,certified_at,published_at
) values
 ('fb180000-0000-4000-8000-000000000001','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','50000000-0000-4000-8000-000000000001','60000000-0000-4000-8000-000000000001',2026,1,'CROSS',1,'{}','published','fb100000-0000-4000-8000-000000000001','fb100000-0000-4000-8000-000000000001',now(),now()),
 ('fb180000-0000-4000-8000-000000000002','11111111-1111-4111-8111-111111111111','fb000000-0000-4000-8000-000000000001','fb030000-0000-4000-8000-000000000001','fb040000-0000-4000-8000-000000000001',2026,1,'CROSS',1,'{}','published','fb100000-0000-4000-8000-000000000004','fb100000-0000-4000-8000-000000000004',now(),now());
...
insert into public.report_card_documents(
 ...
 ('fb190000-0000-4000-8000-000000000002','11111111-1111-4111-8111-111111111111','fb000000-0000-4000-8000-000000000001','fb180000-0000-4000-8000-000000000002','CROSS','1','pdf','report-card-artifacts','school-b/report.pdf','ready','fb100000-0000-4000-8000-000000000004');
