...
-- This test uses today's ISO weekday for its governed subject slot. The product
-- default remains Monday-Friday/5, so make this isolated fixture explicitly
-- seven-day capable to keep the provenance test independent of the CI weekday.
