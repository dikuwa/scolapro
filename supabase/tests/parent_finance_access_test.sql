...
values
  ('fc500000-0000-4000-8000-000000000001','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','50000000-0000-4000-8000-000000000001','PFIN-PAY-LINKED-001','bank_transfer',300,'NAD',current_date-2,'received','fc000000-0000-4000-8000-000000000002'),
  ('fc500000-0000-4000-8000-000000000002','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','50000000-0000-4000-8000-000000000002','PFIN-PAY-OTHER-001','bank_transfer',450,'NAD',current_date-1,'received','fc000000-0000-4000-8000-000000000002');

update public.finance_payments
set status='verified',
    verified_by_user_id='fc000000-0000-4000-8000-000000000002',
    verified_at=now()
where id in (
