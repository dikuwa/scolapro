...
values
('f8000000-0000-4000-8000-000000000001','parent-report-isolation@example.test','authenticated','authenticated',now(),now()),
('f8000000-0000-4000-8000-000000000002','parent-report-fixture-admin@example.test','authenticated','authenticated',now(),now());

insert into public.school_memberships(tenant_id,school_id,user_id,role_key,active_from)
values('11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','f8000000-0000-4000-8000-000000000002','school_admin',current_date-1);
...
values
  ('f8400000-0000-4000-8000-000000000001','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','50000000-0000-4000-8000-000000000001','60000000-0000-4000-8000-000000000001',2026,1,'TEST',1,'{}','published','f8000000-0000-4000-8000-000000000002','f8000000-0000-4000-8000-000000000002',now(),now()),
  ('f8400000-0000-4000-8000-000000000002','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','50000000-0000-4000-8000-000000000001','60000000-0000-4000-8000-000000000001',2026,2,'TEST',1,'{}','draft','f8000000-0000-4000-8000-000000000002',null,null,null),
  ('f8400000-0000-4000-8000-000000000003','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','50000000-0000-4000-8000-000000000002','60000000-0000-4000-8000-000000000002',2026,1,'TEST',1,'{}','published','f8000000-0000-4000-8000-000000000002','f8000000-0000-4000-8000-000000000002',now(),now());
