...
('fd400000-0000-4000-8000-000000000001','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','fd300000-0000-4000-8000-000000000001',2026,(select id from public.grades where school_id='22222222-2222-4222-8222-222222222222' and academic_year=2026 and grade_code='8'),'2026-01-10','current'),
('fd400000-0000-4000-8000-000000000002','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','fd300000-0000-4000-8000-000000000002',2026,(select id from public.grades where school_id='22222222-2222-4222-8222-222222222222' and academic_year=2026 and grade_code='8'),'2026-01-10','current');
