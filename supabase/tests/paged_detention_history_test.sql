...
insert into public.late_detention_obligations(
  ...
  ('fd100000-0000-4000-8000-000000000001','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','50000000-0000-4000-8000-000000000001',3,'2026-03-06','pending',2026,'2026-03-02','2026-03-06',0),
  ...
  ('fd100000-0000-4000-8000-000000000003','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','50000000-0000-4000-8000-000000000002',3,'2026-04-10','pending',2026,'2026-04-06','2026-04-10',0);

update public.late_detention_obligations
set status='completed',
    completed_at=case id
      when 'fd100000-0000-4000-8000-000000000001'::uuid then '2026-03-06 15:00:00+00'::timestamptz
      else '2026-04-10 15:00:00+00'::timestamptz
    end,
    completed_by_user_id='fd000000-0000-4000-8000-000000000001'
where id in (
