...
insert into public.report_card_snapshots(
  ...
  certified_by_user_id,certified_at,published_at,supersedes_snapshot_id
) values
  ...
  ('fb100000-0000-4000-8000-000000000002','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','50000000-0000-4000-8000-000000000001','60000000-0000-4000-8000-000000000001',2026,1,'TEST_REPORT_V1',2,'{"version":2,"result":"corrected"}'::jsonb,'certified','fb000000-0000-4000-8000-000000000001','fb000000-0000-4000-8000-000000000001',now(),null,'fb100000-0000-4000-8000-000000000001');
