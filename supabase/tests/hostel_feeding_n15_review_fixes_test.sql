...
values('fe600000-0000-4000-8000-000000000001','11111111-1111-4111-8111-111111111111','22222222-2222-4222-8222-222222222222','fe500000-0000-4000-8000-000000000001','fe400000-0000-4000-8000-000000000001','2026-01-10','fe000000-0000-4000-8000-000000000001');
...
select lives_ok($$select public.end_hostel_residency((select id from public.hostel_residencies where enrolment_id='fe400000-0000-4000-8000-000000000001' and id<>'fe600000-0000-4000-8000-000000000001'),'2026-02-15')$$,'authorized management can close open residency');
select is((select resident_to from public.hostel_residencies where enrolment_id='fe400000-0000-4000-8000-000000000001' and id<>'fe600000-0000-4000-8000-000000000001'),'2026-02-15'::date,'closure preserves historical end date');
