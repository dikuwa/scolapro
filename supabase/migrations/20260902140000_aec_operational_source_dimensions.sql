...
comment on function public.build_school_operational_snapshot(uuid,integer,date) is
  'Reusable source snapshot for statutory reporting. Includes grade-by-sex learner counts for AEC-style reconciliation while keeping form-specific codes and mappings versioned separately.';
