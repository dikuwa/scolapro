...
4. Do not diagnose the synthetic "ScolaPro Demonstration School" page as current application behavior. Current `main` throws on Vercel when the public Supabase variables are missing instead of silently using preview data.
...
This document is operational guidance only; no credentials belong in the repository.
