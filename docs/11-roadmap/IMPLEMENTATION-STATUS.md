...
| Persistent notifications | DONE FOUNDATION | User-scoped notification inbox, unread count, mark-all-read and clear actions wired into app shell. Domain event producers will be added per workflow. |
...
| Invitations | DONE / VERIFY | Platform admin can choose authorized schools; school admin is restricted by RLS and single-school UI scope. Invitation expiry RPC ambiguity fixed. |

## Timetable and attendance slice

| Area | Status | Notes |
|---|---|---|
| Subjects / subject offerings | DONE FOUNDATION | Operational subject and school/year/grade offering tables exist. |
| Teacher allocations | IN PROGRESS | Canonical allocation model exists and is the next major UI/workflow integration point. |
| Timetable periods / slots | DONE FOUNDATION | Conflict-aware schema exists; full setup/publishing UI remains. |
| Attendance events | DONE FOUNDATION | Date-aware attendance model and reason registry foundation exist. |
| Daily register | IN PROGRESS / VERIFY | Teacher/admin daily register UI, exception-first capture and auditable revisions implemented; continue role/device QA. |
...
- Dashboard metric icon wells and workflow context now use restrained contextual accents instead of remaining visually flat.
...
1. **Teacher allocation workflow and timetable setup/publishing UI.**
2. Complete timetable views for school admin, HOD and teacher contexts.
3. Complete attendance operational flow, including role-appropriate class access and reporting/readiness summaries.
4. Conduct, achievement and learner-support operational slice.
5. LTSM / textbooks / library operational slice.
6. Communications engine and domain notification producers.
7. Admissions, transfers and year-end progression.
8. DNEA readiness.
9. Finance basics.
10. Continue statutory/EMIS and curriculum/planning vertical slices according to the architecture roadmap.
