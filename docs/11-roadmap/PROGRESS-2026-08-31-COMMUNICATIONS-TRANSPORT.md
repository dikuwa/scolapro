...
- For Resend email: `RESEND_API_KEY`, `RESEND_FROM_EMAIL`
...
1. Provision/test real Bird workspace credentials and Namibia sender capability outside source control.
2. Run a live sandbox/test-key SMS send and signed webhook receipt before enabling production communication traffic.
