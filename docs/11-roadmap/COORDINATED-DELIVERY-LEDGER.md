...
## Post-release ownership — 20 September 2026

- #598 — CLOSED / RELEASE GO.
- #577 — CLOSED; authoritative attendance persistence/idempotency accepted.
- #561 — CLOSED; no source defect, representative production role matrix unavailable.
