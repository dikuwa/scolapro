...
const enabledKeysByRole: Record<string, readonly string[]> = {
  ...
  school_admin: ["today", "conduct", "school_invitations", "school_settings", "crc_custody", "setup", "imports", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "library", "statutory", "contributions", "absence_reviews", "calendar"],
  principal: ["today", "conduct", "setup", "school_settings", "crc_custody", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "library", "statutory", "contributions", "absence_reviews", "calendar"],
  deputy_principal: ["today", "conduct", "school_settings", "crc_custody", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "library", "statutory", "contributions", "absence_reviews", "calendar"],
