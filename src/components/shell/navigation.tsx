...
const enabledKeysByRole: Record<string, readonly string[]> = {
  ...
  school_admin: ["today", "school_directory", "conduct", "school_invitations", "school_settings", "crc_custody", "setup", "imports", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "library", "room_inventory", "statutory", "contributions", "absence_reviews", "calendar"],
  principal: ["today", "school_directory", "conduct", "setup", "school_settings", "crc_custody", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "library", "room_inventory", "statutory", "contributions", "absence_reviews", "calendar"],
  deputy_principal: ["today", "school_directory", "conduct", "school_settings", "crc_custody", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "library", "room_inventory", "statutory", "contributions", "absence_reviews", "calendar"],
  ...
  hod: ["today", "school_directory", "conduct", "staff", "learners", "guardians", "timetable", "attendance", "my_detention", "teaching", "assessment", "report_cards", "calendar"],
  teacher: ["today", "school_directory", "conduct", "learners", "timetable", "attendance", "my_detention", "teaching", "assessment", "report_cards", "calendar"],
  class_teacher: ["today", "school_directory", "conduct", "learners", "guardians", "timetable", "attendance", "my_detention", "teaching", "assessment", "report_cards", "contributions", "absence_reviews", "calendar"],
