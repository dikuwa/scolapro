...
const enabledKeysByRole: Record<string, readonly string[]> = {
  ...
  school_admin: ["today", "setup", "imports", "invitations", "staff", "learners", "guardians", "timetable", "attendance", "late_arrivals", "report_cards", "contributions", "absence_reviews", "calendar"],
  principal: ["today", "staff", "learners", "guardians", "timetable", "attendance", "late_arrivals", "assessment", "report_cards", "calendar"],
  deputy_principal: ["today", "staff", "learners", "guardians", "timetable", "attendance", "late_arrivals", "assessment", "report_cards", "calendar"],
  ...
  counsellor: ["today", "learners", "guardians", "calendar"],
