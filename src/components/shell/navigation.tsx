...
const enabledKeysByRole: Record<string, readonly string[]> = {
  ...
  school_admin: ["today", "setup", "invitations", "staff", "learners", "timetable", "attendance", "calendar"],
  principal: ["today", "staff", "learners", "timetable", "attendance", "assessment", "calendar"],
  deputy_principal: ["today", "staff", "learners", "timetable", "attendance", "assessment", "calendar"],
