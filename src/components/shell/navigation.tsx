...
const navigation = [
  ...
  { key: "guardians", label: "Guardians", href: "/guardians", icon: UserRoundSearch },
  ...
  { key: "absence_notices", label: "Absence evidence", href: "/attendance/absence-notices", icon: FolderHeart },
  ...
  { key: "class_lists", label: "Class lists", href: "/reports/class-lists", icon: ClipboardList },
  { key: "examinations", label: "Exam candidates", href: "/examinations/candidates", icon: BadgeHelp },
  { key: "contributions", label: "Contributions", href: "/school/contributions", icon: ReceiptText },
...
const enabledKeysByRole: Record<string, readonly string[]> = {
  ...
  school_admin: ["today", "setup", "imports", "invitations", "staff", "learners", "guardians", "timetable", "attendance", "absence_notices", "late_arrivals", "contributions", "examinations", "report_cards", "class_lists", "calendar"],
  principal: ["today", "staff", "learners", "guardians", "timetable", "attendance", "absence_notices", "late_arrivals", "contributions", "assessment", "examinations", "report_cards", "class_lists", "calendar"],
  deputy_principal: ["today", "staff", "learners", "guardians", "timetable", "attendance", "absence_notices", "late_arrivals", "contributions", "assessment", "examinations", "report_cards", "class_lists", "calendar"],
  hod: ["today", "staff", "learners", "timetable", "attendance", "absence_notices", "teaching", "assessment", "examinations", "report_cards", "class_lists", "calendar"],
  teacher: ["today", "learners", "timetable", "attendance", "absence_notices", "teaching", "assessment", "class_lists", "calendar"],
  class_teacher: ["today", "learners", "guardians", "timetable", "attendance", "absence_notices", "contributions", "teaching", "assessment", "class_lists", "calendar"],
  counsellor: ["today", "learners", "guardians", "absence_notices", "class_lists", "calendar"],
  librarian: ["today", "learners", "class_lists"],
