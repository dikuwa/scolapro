...
const enabledKeysByRole: Record<string, readonly string[]> = {
  ...
  school_admin: ["today", "school_directory", "conduct", "sports_houses", "school_invitations", "school_settings", "crc_custody", "setup", "imports", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "library", "room_inventory", "statutory", "contributions", "absence_reviews", "calendar"],
  principal: ["today", "school_directory", "conduct", "sports_houses", "setup", "school_settings", "crc_custody", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "library", "room_inventory", "statutory", "contributions", "absence_reviews", "calendar"],
  deputy_principal: ["today", "school_directory", "conduct", "sports_houses", "school_settings", "crc_custody", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "library", "room_inventory", "statutory", "contributions", "absence_reviews", "calendar"],
