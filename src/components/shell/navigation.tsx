...
const navigation = [
  ...
  { key: "class_lists", label: "Class Lists", href: "/class-lists", icon: FileSpreadsheet },
...
const enabledKeysByRole: Record<string, readonly string[]> = {
  ...
  hod: ["today", "school_directory", "conduct", "sports_houses", "staff", "learners", "guardians", "timetable", "attendance", "my_detention", "teaching", "assessment", "report_cards", "calendar", "class_lists"],
  teacher: ["today", "school_directory", "conduct", "sports_houses", "learners", "timetable", "attendance", "my_detention", "teaching", "assessment", "report_cards", "calendar", "class_lists"],
  class_teacher: ["today", "school_directory", "conduct", "sports_houses", "learners", "guardians", "timetable", "attendance", "my_detention", "teaching", "assessment", "report_cards", "contributions", "absence_reviews", "calendar", "class_lists"],
  counsellor: ["today", "school_directory", "conduct", "crc_custody", "learners", "guardians", "absence_reviews", "my_detention", "calendar", "class_lists"],
  learner_support: ["today", "school_directory", "crc_custody", "learners", "calendar", "class_lists"],
  social_worker: ["today", "school_directory", "crc_custody", "learners", "calendar", "class_lists"],
  librarian: ["today", "school_directory", "learners", "library", "my_detention", "class_lists"],
  ltsm: ["today", "school_directory", "library", "class_lists"],
