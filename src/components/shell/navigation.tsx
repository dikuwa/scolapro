...
const enabledKeysByRole: Record<string, readonly string[]> = {
  ...
  school_admin: ["today", "setup", "imports", "invitations", "staff", "learners", "timetable", "attendance", "late_arrivals", "report_cards", "calendar"],
  principal: ["today", "staff", "learners", "timetable", "attendance", "late_arrivals", "assessment", "report_cards", "calendar"],
  deputy_principal: ["today", "staff", "learners", "timetable", "attendance", "late_arrivals", "assessment", "report_cards", "calendar"],
  hod: ["today", "staff", "learners", "timetable", "attendance", "teaching", "assessment", "report_cards", "calendar"],
