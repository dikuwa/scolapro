...
const enabledKeysByRole: Record<string, readonly string[]> = {
  ...
  school_admin: ["today", "setup", "imports", "invitations", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "report_cards", "contributions", "absence_reviews", "calendar"],
  principal: ["today", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "assessment", "report_cards", "calendar"],
  deputy_principal: ["today", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "assessment", "report_cards", "calendar"],
  hod: ["today", "staff", "learners", "guardians", "timetable", "attendance", "teaching", "assessment", "report_cards", "calendar"],
  teacher: ["today", "learners", "timetable", "attendance", "teaching", "assessment", "report_cards", "calendar"],
  class_teacher: ["today", "learners", "guardians", "timetable", "attendance", "teaching", "assessment", "report_cards", "contributions", "calendar"],
  counsellor: ["today", "learners", "guardians", "data_corrections", "calendar"],
