...
const enabledKeysByRole: Record<string, readonly string[]> = {
  ...
  school_admin: ["today", "setup", "invitations", "staff", "learners", "attendance", "calendar"],
  principal: ["today", "staff", "learners", "attendance", "assessment", "calendar"],
  deputy_principal: ["today", "staff", "learners", "attendance", "assessment", "calendar"],
  hod: ["today", "staff", "learners", "attendance", "teaching", "assessment", "calendar"],
  teacher: ["today", "learners", "attendance", "teaching", "assessment", "calendar"],
  class_teacher: ["today", "learners", "attendance", "teaching", "assessment", "calendar"],
