...
const enabledKeysByRole: Record<string, readonly string[]> = {
  ...
  school_admin: ["today", "school_invitations", "school_settings", "crc_custody", "setup", "imports", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "contributions", "absence_reviews", "calendar"],
  principal: ["today", "school_settings", "crc_custody", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "calendar"],
  deputy_principal: ["today", "school_settings", "crc_custody", "staff", "learners", "guardians", "data_corrections", "timetable", "attendance", "late_arrivals", "my_detention", "teaching", "assessment", "report_cards", "calendar"],
  ...
  counsellor: ["today", "crc_custody", "learners", "guardians", "data_corrections", "my_detention", "calendar"],
