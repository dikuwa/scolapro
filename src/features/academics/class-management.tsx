...
type RegisterClass = { id: string; code: string; name: string; gradeId: string; homeRoom: { id: string; code: string; name: string; block: string | null } | null };
