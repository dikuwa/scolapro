...
export default async function ParentPage() {
  ...
  return <AppShell>
    <section>
      ...
      <ParentPortal familyChildren={data.children} reports={data.reports} documents={data.documents} invoices={data.invoices} payments={data.payments} messages={data.messages} claimable={data.claimable} absenceNotices={data.absenceNotices} />
    </section>
  </AppShell>;
}
