...
import { getParentAbsenceNotices } from "@/features/parents/server/absence-queries";
...
export default async function ParentPage() {
  ...
  const [data, absenceNotices] = await Promise.all([getParentPortalData(), getParentAbsenceNotices()]);
  ...
  return <AppShell>
    <section>
      ...
      <ParentPortal familyChildren={data.children} reports={data.reports} documents={data.documents} invoices={data.invoices} payments={data.payments} messages={data.messages} claimable={data.claimable} correctionRequests={data.correctionRequests} absenceNotices={absenceNotices} today={today} />
    </section>
  </AppShell>;
}
