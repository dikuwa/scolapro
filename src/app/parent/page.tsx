...
export default async function ParentPage() {
  ...
  return <AppShell>
    <section>
      ...
      <ParentPortal familyChildren={data.children} reports={data.reports} documents={data.documents} invoices={data.invoices} payments={data.payments} claimable={data.claimable} />
    </section>
  </AppShell>;
}
