...
function ImportCard({ icon, tone, title, description, inputId, label, helper, button, action }: { icon: ReactNode; tone: string; title: string; description: string; inputId: string; label: string; helper: string; button: string; action: (formData: FormData) => void | Promise<void> }) {
