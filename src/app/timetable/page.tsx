  ...
  return (
    <AppShell>
      <section>
        ...
        {canManage ? <div className="mt-5"><TimetableOfferingMaintenance schoolId={membership.schoolId} academicYear={academicYear} offerings={workspace.offerings} /></div> : null}
        {canManage ? <div className="mt-5"><TimetablePeriodMaintenance schoolId={membership.schoolId} academicYear={academicYear} periods={workspace.periods} /></div> : null}
