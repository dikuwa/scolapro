...
export default async function TimetablePage() {
  ...
  return (
    <AppShell>
      <section>
        <div className="mb-6">
          <h1 className="text-[clamp(1.25rem,1.08rem+0.45vw,1.65rem)] font-semibold tracking-[-0.035em]">Timetable</h1>
          <p className="mt-1 max-w-2xl text-sm leading-6 text-muted-foreground">
            {canManage
              ? "Configure subjects, teacher allocations, school periods and conflict-safe timetable slots from one connected workspace."
              : "View the current school timetable generated from governed subject and teacher allocations."}
          </p>
        </div>
