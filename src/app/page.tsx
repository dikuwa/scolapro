...
export default async function Home() {
  ...
  const metrics = dashboardMode === "platform"
    ? [
        ...
        { label: "Registered schools", value: platformOverview.schoolCount.toLocaleString("en-NA"), detail: "Schools across current tenants", icon: School, tone: "scolapro-tone-mint", valueColor: "text-[color:var(--accent-mint)]" },
        { label: "Platform access", value: "Admin", detail: "Tenant onboarding and governance", icon: ShieldCheck, tone: "scolapro-tone-amber", valueColor: "text-[color:var(--accent-amber)]" },
      ]
    : [
        { label: "Current learners", value: overview.currentLearners.toLocaleString("en-NA"), detail: `Academic year ${academicYear}`, icon: Users, tone: "scolapro-tone-brand", valueColor: "text-[color:var(--accent-indigo)]" },
        { label: "Configured grades", value: overview.gradeCount.toLocaleString("en-NA"), detail: "Available in this school context", icon: BookOpenCheck, tone: "scolapro-tone-mint", valueColor: "text-[color:var(--accent-mint)]" },
        { label: "Register classes", value: overview.registerClassCount.toLocaleString("en-NA"), detail: "Current academic-year structure", icon: School, tone: "scolapro-tone-amber", valueColor: "text-[color:var(--accent-amber)]" },
      ];
