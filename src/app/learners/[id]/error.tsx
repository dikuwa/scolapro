...
export default function LearnerOverviewError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <section className="rounded-[var(--radius-md)] bg-surface p-5 shadow-[var(--shadow-xs)]">
      <h2 className="scolapro-section-title">Learner overview could not load</h2>
      <p className="scolapro-section-description">
        The current-school learner record could not be loaded. No learner identity, enrolment or guardian record was changed.
      </p>
