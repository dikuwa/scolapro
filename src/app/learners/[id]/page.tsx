      ...
      <section>
        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1.35fr)_minmax(18rem,0.65fr)]">
          ...
          <aside className="space-y-3">
            ...
            <section className="bg-surface p-4 shadow-[var(--shadow-xs)] sm:p-5"><div className="flex items-start gap-3"><span className="grid size-9 shrink-0 place-items-center rounded-[var(--radius-sm)] bg-surface-muted text-muted-foreground"><FileText aria-hidden="true" className="size-4" /></span><div><h2 className="scolapro-section-title">Longitudinal record</h2><p className="scolapro-section-description">Academic, attendance, support and transfer history stays linked without rewriting records created by an earlier school.</p></div></div></section>
          </aside>
        </div>
