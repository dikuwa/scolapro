    ...
    <AppShell>
      <section>
        <div className="mb-6">
          ...
          <p className="mt-1 max-w-2xl text-sm leading-6 text-muted-foreground">Create and manage school access across the ScolaPro platform. Once a school is operating, routine staff invitations belong to that school&apos;s administrators — not to platform operations.</p>
        </div>
        ...
        <div className="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1.05fr)_minmax(22rem,0.95fr)] xl:items-start">
          <section className="rounded-[var(--radius-md)] bg-surface p-4 shadow-[var(--shadow-xs)] sm:p-5">
            <div className="mb-4 flex items-center gap-2 border-b border-border-subtle pb-4"><span className="scolapro-tone-brand grid size-8 shrink-0 place-items-center rounded-[var(--radius-sm)]"><MailPlus className="size-4" aria-hidden="true" /></span><div><h2 className="scolapro-section-title">Platform invitation history</h2><p className="scolapro-section-description !mt-0">Recent governed invitations across platform-managed schools.</p></div></div>
          ...
          <div className="space-y-5">
            <section className="rounded-[var(--radius-md)] bg-surface-muted p-4 sm:p-5">
              <h2 className="scolapro-section-title">Establish school access</h2>
              <p className="scolapro-section-description">Platform onboarding can establish the first School Administrator or other explicitly platform-governed access. Routine staff invitations are handled by each school&apos;s administration.</p>
