...
export default async function PlatformInvitationsPage() {
  ...
  return (
    <AppShell>
      <section>
        <div className="mb-6"><h1 className="scolapro-page-title text-[clamp(1.25rem,1.08rem+0.45vw,1.65rem)]">User invitations</h1><p className="mt-1 max-w-2xl text-sm leading-6 text-muted-foreground">Invite school users into an explicit school and role scope. The secure join token is shown only when the invitation is created.</p></div>
